...
if (isset($_POST['create_account'])) {
    ...
    $message = "Dear $name thank you for your registration to UMURENGE SACCO";
    ...
    try {
        ...
        $query = "INSERT INTO clients (name, national_id, client_number, phone, email, password, sacco_id) VALUES (?,?,?,?,?,?,?)";
        $stmt = $mysqli->prepare($query);
        //bind paramaters
        $rc = $stmt->bind_param('sssssss', $name, $national_id, $client_number, $phone, $email, $password, $sacco_id);
        $stmt->execute();
