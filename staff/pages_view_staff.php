...
if (isset($_POST['update_staff_account'])) {
    ...
    try {
        ...
        $query = "UPDATE staff SET name=?, phone=?, email=?, sex=?, profile_pic=? WHERE staff_number=?";
        $stmt = $mysqli->prepare($query);
        $stmt->execute([$name, $phone, $email, $sex, $profile_pic, $staff_number]);
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-purple card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">Staff @Sacco </p>
                                        ...
                                        <ul class="list-group list-group-unbordered mb-3">
                                            ...
                                            <li class="list-group-item">
                                                <b>StaffNo: </b> <a class="float-right">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane active" id="update_Profile">
                                                <form method="post" enctype="multipart/form-data" class="form-horizontal">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputEmail" class="col-sm-2 col-form-label">Post</label>
                                                        <div class="col-sm-10">
                                                       
                                                             <select class="form-control" name="post">
                                                        <option <?php if ($row->post == 'teller') {
                                                                                echo 'selected';  }
                                                                                 else { echo '';
                                                                            }?>  value="teller">Teller</option>
                                                        <option <?php if ($row->post == 'loan_officer') {
                                                                                echo 'selected';  }
                                                                                 else { echo '';
                                                                            }?>  value="loan_officer">Loan Officer</option>
                                                </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" minlength="10" maxlength="10" class="form-control phone" required name="phone" value="<?php echo $row->phone; ?>" id="inputName2">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="inputName2" class="col-sm-2 col-form-label">Gender <?= $row->sex ?></label>
                                                        <div class="col-sm-10">
