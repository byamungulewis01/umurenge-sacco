          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_add_client.php"
                    class="nav-link <?php echo ($current_page == 'pages_add_client') ? 'active' : ''; ?>">
                    <i class="fas fa-user-plus nav-icon"></i>
                    <p>Add Client</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_manage_clients.php"
                    class="nav-link <?php echo ($current_page == 'pages_manage_clients' || $current_page == 'pages_view_client') ? 'active' : ''; ?>">
            ...
            <!--iBank Accounts-->
            <li
              class="nav-item has-treeview <?php echo ($current_page == 'pages_add_acc_type' || $current_page == 'pages_manage_accs' || $current_page == 'pages_open_acc' || $current_page == 'pages_manage_acc_openings' || $current_page == 'pages_update_client_accounts') ? 'show menu-open' : ''; ?>">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_open_acc.php"
                    class="nav-link  <?php echo ($current_page == 'pages_open_acc') ? 'active' : ''; ?>">
                ...
                <li class="nav-item">
                  <a href="pages_manage_acc_openings.php"
                    class="nav-link  <?php echo ($current_page == 'pages_manage_acc_openings' || $current_page == 'pages_update_client_accounts') ? 'active' : ''; ?>">
