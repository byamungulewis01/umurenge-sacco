...
if (isset($_POST['open_account'])) {
    ...
    try {
        ...
        //bind paramaters
        $stmt->execute([$acc_name, $account_number, $acc_type, $acc_status, $acc_amount, $client_id,$sacco_id]);
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class=" col-md-6 form-group">
                                                    ...
                                                    <input type="hidden" value="<?php echo $row->sacco_id; ?>" name="sacco_id" class="form-control">
                                            </div>
