        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="pages_dashboard.php" class="nav-link <?php echo ($current_page == 'pages_dashboard') ? 'active' : ''; ?>">
            ...
            <!--Account -->
            <li class="nav-item">
              <a href="pages_account.php" class="nav-link <?php echo ($current_page == 'pages_account') ? 'active' : ''; ?>">
            ...
            <li class="nav-item has-treeview <?php echo ($current_page == 'pages_add_staff' || $current_page == 'pages_manage_staff' || $current_page == 'pages_manage_sacco' || $current_page == 'pages_view_staff') ? 'show menu-open' : ''; ?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="pages_manage_sacco.php" class="nav-link <?php echo ($current_page == 'pages_manage_sacco') ? 'active' : ''; ?>">
            ...
            <!--Clients -->
            <li class="nav-item has-treeview <?php echo ($current_page == 'pages_add_client' || $current_page == 'pages_manage_clients' || $current_page == 'pages_view_client') ? 'show menu-open' : ''; ?>">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_add_client.php" class="nav-link <?php echo ($current_page == 'pages_add_client') ? 'active' : ''; ?>">
                    <i class="fas fa-user-plus nav-icon"></i>
                    <p>Add Client</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_manage_clients.php" class="nav-link <?php echo ($current_page == 'pages_manage_clients') ? 'active' : ''; ?>">
                    <i class="fas fa-user-cog nav-icon"></i>
                    <p>Manage Clients</p>
                  </a>
                </li>
            ...
            <!--iBank Accounts-->
            <li class="nav-item has-treeview <?php echo ($current_page == 'pages_add_acc_type' || $current_page == 'pages_manage_accs' || $current_page == 'pages_open_acc' || $current_page == 'pages_manage_acc_openings' || $current_page == 'pages_update_client_accounts') ? 'show menu-open' : ''; ?>">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_add_acc_type.php" class="nav-link  <?php echo ($current_page == 'pages_add_acc_type') ? 'active' : ''; ?>">
                    <i class="far fas fa-plus nav-icon"></i>
                    <p>Add Acc Type</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_manage_accs.php" class="nav-link  <?php echo ($current_page == 'pages_manage_accs') ? 'active' : ''; ?>">
                ...
                <li class="nav-item">
                  <a href="pages_manage_acc_openings.php" class="nav-link  <?php echo ($current_page == 'pages_manage_acc_openings' || $current_page == 'pages_update_client_accounts') ? 'active' : ''; ?>">
            ...
            <!-- <li class="nav-item has-treeview <?php echo ($current_page == 'pages_deposits' || $current_page == 'pages_withdrawals'
                                                ...
                                                || $current_page == 'pages_view_client_bank_acc'
                                              ) ? 'show menu-open' : ''; ?>">
              <a href="#" class="nav-link">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="pages_deposits.php" class="nav-link <?php echo ($current_page == 'pages_deposits' || $current_page == 'pages_deposit_money') ? 'active' : ''; ?>">
                    <i class="fas fa-upload nav-icon"></i>
                    <p>Deposits</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_withdrawals.php" class="nav-link <?php echo ($current_page == 'pages_withdrawals' || $current_page == 'pages_withdraw_money') ? 'active' : ''; ?>">
                    <i class="fas fa-download nav-icon"></i>
                    <p>Withdrawals</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="pages_transfers.php" class="nav-link <?php echo ($current_page == 'pages_transfers' || $current_page == 'pages_transfer_money') ? 'active' : ''; ?>">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                  <a href="pages_balance_enquiries.php" class="nav-link <?php echo ($current_page == 'pages_balance_enquiries' || $current_page == 'pages_view_client_bank_acc') ? 'active' : ''; ?>">
          ...
          ./Statements -->
            ...
            <li class="nav-item">
              <a href="pages_transactions_engine.php" class="nav-link <?php echo ($current_page == 'pages_transactions_engine') ? 'active' : ''; ?>">
            ...
            <!--Password Resets-->
            <li class="nav-item">
              <a href="pages_system_settings.php" class="nav-link <?php echo ($current_page == 'pages_system_settings') ? 'active' : ''; ?>">
